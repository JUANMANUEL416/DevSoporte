const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'qrystalos_modulos', component: () => import('pages/QrystalosProcesosPage.vue') },
      { path: 'plan_trabajo', component: () => import('pages/PlanTrabajoPage.vue') },
      ...
      { path: 'actas_reunion', component: () => import('pages/ActaReunionPage.vue') },
